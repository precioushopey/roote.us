export const en = {
  ...
  'common.whatThisMeans': "What this means",
  'common.hideDetails': "Hide details",
  'common.close': "Close",
  'common.readMore': "Read more",
  'common.beforeAfterComparison': "{before} / {after} comparison",
  'common.brandOf': "A brand of",
  'common.packagingAlt': "{name} packaging",
  'notFound.policy.title': "Policy",
  'notFound.policy.body': "This policy page could not be found.",
  'notFound.product.title': "Product",
  'notFound.product.body': "This product could not be found.",
  'notFound.solution.title': "Solution",
  'notFound.solution.body': "This solution page could not be found.",
  ...
  'auth.login.withOrder': "Sign in with your order number instead",
  'auth.login.withPassword': "Sign in with a password instead",
  'auth.login.orderLabel': "Order number",
  'auth.login.orderHint': "You’ll find it on your order confirmation.",
  'auth.login.error.orderNotFound': "We couldn’t find an order with that number and email.",
  'auth.login.error.noPassword': "This account has no password yet. Sign in with your order number instead.",
  'auth.signUp.confirmLabel': "Confirm password",
  'auth.signUp.error.mismatch': "Passwords don’t match.",
  ...
  'checkout.mobileHint': "For delivery updates only.",
  'checkout.city': 'City',
  'checkout.postal': 'Postal code',
  'checkout.state': "State",
  'checkout.country': "Country",
  'checkout.countryUS': "United States",
  ...
  'checkout.shippingSameAsBilling': "Shipping address is the same as billing",
  ...
  'checkout.error.mobile': "Enter a valid U.S. mobile number.",
  'checkout.error.postal': "Enter a valid 5-digit ZIP code.",
  'start.success.title': "You're all set",
  'start.success.saveOrderNote': 'Screenshot this screen or copy your order number so you can log in later.',
  'start.success.copyOrderId': 'Copy order number',
  'start.success.copied': 'Copied',
  ...
  'bag.success.analysisTitle': "Haven’t taken your free hair analysis yet?",
  'bag.success.analysisBody': "Take it now — you’ll see your results and treatment direction in your account.",
