...
export const LEGAL_PAGES: LegalPage[] = [
  ...
  },
  {
    ...
    blurb: L('The rules for using ROOTÉ.US.', 'הכללים לשימוש ב-ROOTÉ.US.'),
    reviewRequired: true,
...
export const LEGAL_BODIES: Record<string, LegalSection[]> = {
  ...
  terms: [
    S('acceptance', 'Acceptance', 'קבלת התנאים',
      'By using ROOTÉ.US you agree to these terms.',
      'השימוש ב-ROOTÉ.US מהווה הסכמה לתנאים אלה.'),
    S('the-service', 'The service', 'השירות',
      'ROOTÉ provides a guided hair analysis, a personalized program recommendation, and tools to track a program. This is a concept build; features may change.',
      'ROOTÉ מספקת אבחון שיער מודרך, המלצת תוכנית אישית וכלים למעקב. זו גרסת קונספט; תכונות עשויות להשתנות.'),
  ...
  'medical-disclaimer': [
    S('not-a-diagnosis', 'Not a diagnosis', 'לא אבחנה',
      'The ROOTÉ hair analysis is a preliminary, photo-based visual assessment. It is not a medical diagnosis.',
      'אבחון השיער של ROOTÉ הוא הערכה חזותית ראשונית מבוססת תמונות. אינו אבחנה רפואית.'),
    ...
    S('ingredients-and-claims', 'Ingredients & claims', 'רכיבים וטענות',
      'Formula and claim information is subject to regulatory review. ROOTÉ does not present an ingredient study or a competitor study as its own, and makes no guarantee of regrowth or of slowing or reversing gray hair.',
      'מידע על הפורמולה והטענות כפוף לבדיקה רגולטורית. ROOTÉ אינה מציגה מחקר של רכיב או של מתחרה כשלה, ואינה מבטיחה צמיחה מחדש או האטה/היפוך של שיער אפור.'),
  ...
  accessibility: [
    S('commitment', 'Our commitment', 'המחויבות שלנו',
      'We want ROOTÉ.US to be usable by as many people as possible, including people who use assistive technology.',
      'אנו רוצים ש-ROOTÉ.US יהיה שמיש לכמה שיותר אנשים, כולל משתמשי טכנולוגיה מסייעת.'),
