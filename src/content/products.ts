  ...
  },
  {
    ...
    ingredients: [
      ...
      ING(
        'ABN Complex™',
        L6({
          en: 'A supplier hair-nutrient blend included alongside Minoxidil and Finasteride in this formula, aimed at nourishing the scalp and supporting overall hair health.',
          he: 'תערובת של ספק לתזונת השיער, הנכללת לצד מינוקסידיל ופינסטריד בפורמולה זו, ונועדה להזין את הקרקפת ולתמוך בבריאות השיער בכללותה.',
          ar: 'مزيج من مورّد خارجي لتغذية الشعر، يُدرَج إلى جانب Minoxidil وFinasteride في هذه التركيبة، ويهدف إلى تغذية فروة الرأس ودعم صحة الشعر عمومًا.',
          ru: 'Смесь питательных веществ для волос от поставщика, включённая в эту формулу наряду с Minoxidil и Finasteride и призванная питать кожу головы и поддерживать общее здоровье волос.',
          fr: 'Un mélange nutritif pour cheveux fourni par un tiers, intégré à cette formule aux côtés du Minoxidil et du Finasteride, visant à nourrir le cuir chevelu et à soutenir la santé globale des cheveux.',
          es: 'Una mezcla nutritiva para el cabello de un proveedor externo, incluida en esta fórmula junto con Minoxidil y Finasteride, pensada para nutrir el cuero cabelludo y apoyar la salud general del cabello.',
        }),
        'working',
  ...
  },
  {
    ...
    ingredients: [
      ING(
        'Greyverse™',
        L6({
          en: "A biomimetic peptide (palmitoyl tetrapeptide-20) used in anti-gray formulas, aimed at supporting the scalp's natural pigment activity and the hair's own antioxidant defenses so new growth can look less gray over time.",
          he: 'פפטיד ביומימטי (Palmitoyl Tetrapeptide-20) הנפוץ בפורמולות נגד שיער אפור, שנועד לתמוך בפעילות הפיגמנט הטבעית של הקרקפת ובהגנות נוגדי החמצון של השיער עצמו, כך שצמיחה חדשה תיראה פחות אפורה עם הזמן.',
          ar: 'ببتيد محاكٍ حيويًا (Palmitoyl Tetrapeptide-20) يُستخدم في تركيبات الشيب، ويهدف إلى دعم نشاط الصبغة الطبيعي في فروة الرأس والدفاعات المضادة للأكسدة في الشعر نفسه، ليبدو الشعر النامي حديثًا أقل رمادية مع مرور الوقت.',
          ru: 'Биомиметический пептид (Palmitoyl Tetrapeptide-20), применяемый в формулах против седины. Предназначен для поддержки естественной пигментной активности кожи головы и собственной антиоксидантной защиты волос, чтобы новые волосы со временем выглядели менее седыми.',
          fr: "Un peptide biomimétique (Palmitoyl Tetrapeptide-20) utilisé dans les formules contre les cheveux gris, conçu pour soutenir l'activité pigmentaire naturelle du cuir chevelu et les défenses antioxydantes du cheveu, afin que la repousse paraisse moins grise avec le temps.",
          es: 'Un péptido biomimético (Palmitoyl Tetrapeptide-20) utilizado en fórmulas para las canas, pensado para apoyar la actividad natural del pigmento del cuero cabelludo y las defensas antioxidantes del propio cabello, de modo que el crecimiento nuevo se vea menos canoso con el tiempo.',
        }),
        'working',
        'competitor-reference',
        '2%',
      ...
      ING(
        'Darkenyl™',
        L6({
          en: "A pigmentation-support active (acetyl tyrosine with larch wood extract) aimed at supporting the follicle's natural melanin production, to help new growth keep its natural color for longer.",
          he: 'רכיב פעיל לתמיכה בפיגמנט (Acetyl Tyrosine עם תמצית עץ Larix Europaea) שנועד לתמוך בייצור המלנין הטבעי של הזקיק, כדי לסייע לצמיחה חדשה לשמור על צבעה הטבעי לאורך זמן.',
          ar: 'مكوّن فعّال لدعم التصبغ (Acetyl Tyrosine مع مستخلص خشب Larix Europaea) يهدف إلى دعم إنتاج الميلانين الطبيعي في البصيلة، لمساعدة الشعر النامي حديثًا على الاحتفاظ بلونه الطبيعي لفترة أطول.',
          ru: 'Активный ингредиент для поддержки пигментации (Acetyl Tyrosine с экстрактом древесины лиственницы), направленный на поддержку естественной выработки меланина в фолликуле, чтобы новые волосы дольше сохраняли природный цвет.',
          fr: 'Un actif de soutien de la pigmentation (Acetyl Tyrosine avec extrait de bois de mélèze) visant à soutenir la production naturelle de mélanine du follicule, pour aider la repousse à conserver plus longtemps sa couleur naturelle.',
          es: 'Un activo de apoyo a la pigmentación (Acetyl Tyrosine con extracto de madera de alerce) pensado para apoyar la producción natural de melanina del folículo y ayudar a que el crecimiento nuevo conserve su color natural por más tiempo.',
        }),
        'working',
        'competitor-reference',
        '1%',
      ...
      ING(
        'Capixyl™',
        L6({
          en: 'A peptide-based scalp-care active (acetyl tetrapeptide-3 in a plant-derived complex) aimed at supporting the follicle environment and the look of fuller hair.',
          he: 'רכיב פעיל מבוסס פפטידים לטיפוח הקרקפת (Acetyl Tetrapeptide-3 בתוך קומפלקס ממקור צמחי) שנועד לתמוך בסביבת הזקיק ובמראה של שיער מלא יותר.',
          ar: 'مكوّن فعّال قائم على الببتيدات للعناية بفروة الرأس (Acetyl Tetrapeptide-3 ضمن مركّب نباتي المصدر) يهدف إلى دعم بيئة البصيلة ومظهر الشعر الأكثر كثافة.',
          ru: 'Активный пептидный ингредиент для ухода за кожей головы (Acetyl Tetrapeptide-3 в комплексе растительного происхождения), направленный на поддержку среды фолликула и внешний вид более густых волос.',
          fr: "Un actif peptidique de soin du cuir chevelu (Acetyl Tetrapeptide-3 dans un complexe d'origine végétale) visant à soutenir l'environnement du follicule et l'aspect de cheveux plus fournis.",
          es: 'Un activo a base de péptidos para el cuidado del cuero cabelludo (Acetyl Tetrapeptide-3 en un complejo de origen vegetal) pensado para apoyar el entorno del folículo y el aspecto de un cabello más denso.',
        }),
        'working',
        'competitor-reference',
        '2%',
