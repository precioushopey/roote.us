  ...
  return (
    <>
      <Section tone="teal" width="content" animate={false} className="text-center">
        ...
        <Prose onDark size="lg" className="mx-auto mt-4 text-center">{t('marketing.legalSale.intro')}</Prose>
          ...
          {SECTION_KEYS.map((s, i) => (
            <div key={s} className="flex gap-4 border-b border-ink-foreground/15 pb-8 last:border-b-0">
              ...
              <div>
                ...
                <Prose onDark className="mt-3">{t(`marketing.legalSale.${s}.body` as MessageKey)}</Prose>
              </div>
            </div>
          ))}
        </div>
