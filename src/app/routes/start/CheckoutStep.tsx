    ...
    <div className="mx-auto flex max-w-lg flex-col gap-6">
      <section className="rounded-xl border border-border bg-card p-5">
        <div className="flex items-center justify-between">
          ...
          <Link to={withLocale('/program/plan')} className="font-body text-sm text-deep-800 underline">
      ...
      <div className="rounded-xl border border-border bg-cream-100 p-4">
        <label className="flex cursor-pointer items-start gap-3">
          ...
          <span className="font-body text-sm">
            ...
            <span className="mt-0.5 block text-sm text-muted-foreground">{t('program.checkout.subscriptionBody')}</span>
          </span>
        </label>
        <p className="mt-2 font-body text-sm text-muted-foreground">{t('program.checkout.noSurprise')}</p>
      </div>
